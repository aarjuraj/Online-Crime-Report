<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ForwardCaution.aspx.cs" Inherits="_Default" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="content1" runat="server">
   <asp:TextBox ID="TextBox1" runat="server" Style="z-index: 100; left: 448px; position: absolute;
    ...
    <br />
    <br />
    <asp:Label ID="Label5" runat="server" Style="z-index: 109; left: 240px; position: absolute;
        top: 208px" Text="Administrator Mail Id :"></asp:Label>
    <br />
    <br />
    <br />
    <br />
